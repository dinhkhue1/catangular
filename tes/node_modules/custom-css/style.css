...
blockquote:before{
    ...
    width: 29px;
    height: 23px;
    background-image:url('../../src/assets/blockquote-left.png');
...
blockquote:after{
    ...
    width: 29px;
    height: 23px;
    background-image:url('../../src/assets/blockquote-right.png');
    background-repeat: no-repeat;
    background-position: center center;
    margin-right: -29px;
...
.header.sidebar .line-header{
    ...
    height: 6px;
    display: block;
    background: url('../../src/assets/driver.png') no-repeat center left;
    display: block;
    margin: 0 auto;
    padding: 30px 0;
    float: left;
...
.header-categoy-menu.opened{
    ...
    min-width: 375px;
    max-width: 375px;
    background-image: url('../../src/assets/bg-header-menu.jpg');
...
.footer .widget .widget-title:after{
    ...
    height: 6px;
    display: block;
    background: url('../../src/assets/driver.png') no-repeat center center;
    display: block;
    margin: 0 auto;
    margin-top: 10px;
}
...
.footer.style8{
    ...
    font-size: 13px;
    color: #666;
    background-image: url('../../src/assets/b/footer-bg.jpg');
    background-repeat: no-repeat;
}
...
.section-title.style2 h3:after{
    ...
    height: 10px;
    background-color: transparent;
    background-image: url('../../src/assets/arow.png');
    background-position: center center;
    background-repeat: no-repeat;
    margin-top: 15px;
}
...
.text-border:before {
    background: url("../../src/assets/cut.png") no-repeat;
    content: "";
    height: 22px;
    float: left;
    width: 35px;
...
.block-category-carousel{
    ...
    background:#121111 url('../../src/assets/bg_cat.png') repeat-y top left;
    color: #eee;
    text-align: center;
}
...
.product-details-right .size-chart a:after{
    content:'';
    background: url('../../src/assets/size-char.png') no-repeat;
    display: inline-block;
    width: 14px;
    height: 14px;
    margin-left: 20px;
...
.testimonials.style2 .text-in:before {
    ...
    width: 47px;
    height: 33px;
    background-image: url('../../src/assets/t-left.png');
    background-repeat: no-repeat;
    background-position: center center;
    margin-left: -75px;
    position: absolute;
...
.testimonials.style2 .text-in:after {
    ...
    width: 47px;
    height: 33px;
    background-image: url('../../src/assets/t-right.png');
    background-repeat: no-repeat;
    background-position: center center;
    position: absolute;
    right: 0;
...
.block-newletter.style3 .newletter .button{
    ...
    padding: 0;
    margin: 0;
    background: url('../../src/assets/check.png') no-repeat center center;
    font-size: 0;
    top: 10px;
}
...
/* BANNER PAGE */
.page-banner{
    background-image: url("../../src/assets/b/43.jpg");
    background-repeat: no-repeat;
    background-attachment: fixed;
    background-size: cover;
...
.contact-banner{
    background-image: url("../../src/assets/b/45.jpg");
}
...
.block-kt-banner.style5 .video .button-play{
    background: url('../../src/assets/play2.png') no-repeat;
    width: 64px;
    height: 64px;
}
...
.block-paralax1{
    ...
    background-image: url('../../src/assets/b/pralax1.jpg');
}
.block-paralax2{
    margin-top: 60px;
    background-image: url('../../src/assets/b/pralax2.jpg');
    padding-bottom: 120px;
}
.block-paralax3{
    margin-top: 60px;
    padding: 87px 0 110px 0;
    background-image: url('../../src/assets/b/pralax4.jpg');
    font-family: 'MontserratLight';
}
...
.block-paralax4{
    ...
    margin-top: 60px;
    background-image: url('../../src/assets/b/bg-19.jpg');
}
.block-paralax4 .head{
    text-align: center;
    color: #fff;
...
.section-testimonials{
    background-image: url("../../src/assets/b/44.png");
...
.block-paralax5{
    ...
    background-image: url("../../src/assets/b/pralax3.jpg");
}
.block-paralax5 .head{
    text-align: center;
    color: #fff;
